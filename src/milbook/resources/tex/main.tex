...
\newtcolorbox{blackboard}{
    colback=green!30!black, % A dark green
    coltext=white,
    colframe=brown,
    boxrule=4pt,
...
\let\oldDisplayMath\[
\renewcommand{\[}{\begin{blackboard}\oldDisplayMath}
\let\oldEndDisplayMath\]
\renewcommand{\]}{\oldEndDisplayMath\end{blackboard}}

 %\usepackage[cal=bickhams,calscaled=.96]{mathalpha}
 \setmathfont{STIX Two Math}
 \newfontfamily{\mathtextfont}{Schoolbell}
 % In your preamble, after the line above
\newcommand{\mtext}[1]{{\mathtextfont\text{#1}}}
